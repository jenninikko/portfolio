...
* I can read code and have basic programming skills in JavaScript and Python, enabling seamless collaboration with developer teams.
* Proven track of building style guides and documentation processes from scratch.
* Collaborative approach involving close integration with developers, architects, and product owners to translate complex system designs into clear, usable documentation.
...
* **ASD-STE100** (2021): International specification for controlled-language technical documentation — applied directly to enterprise and safety-critical documentation environments.
* **UX Design: Information Architecture** (2021): Information architecture, accessibility and inclusive design, mind-mapping for complex content structures.
* **Middle Management Training** (2020): Project management, mentoring, conflict resolution, change management — applied during managerial position at B-Telecom.

---

## Contact Me

📧 [evgeniianikko@protonmail.com](mailto:evgeniianikko@protonmail.com)